...
"\<lambda>sb. senderIn_stream_as_i\<cdot>(aBP_get_stream_mediumRs_o__sender_as\<cdot>sb)\<cdot>(aBP_get_stream_i__sender_i\<cdot>sb)"
...
"\<lambda>sb. receiverIn_stream_dr\<cdot>(aBP_get_stream_mediumSr_o__receiver_dr\<cdot>sb)"
  by (simp add: cfun_def)
...
"aBPMediumSr = ((uspecConst mediumSrInConverterSPF)\<circle>fairMediumSPS\<circle>(uspecConst mediumSrOutConverterSPF))"
...
"aBPMediumRs = ((uspecConst mediumRsInConverterSPF)\<circle>fairMediumSPS\<circle>(uspecConst mediumRsOutConverterSPF))"
