 ...
 *
 * Generated on Oct 2, 2018 7:58:18 PM by isartransformer 1.0.0
 *)
...
datatype ('e::countable) receiverMessage = DoNotUse_f10ac2_ReceiverPair_E_Bool "('e\<times>bool)" | DoNotUse_f10ac2_ReceiverBool "bool" | DoNotUse_f10ac2_ReceiverE "'e"
...
begin
  ...
  "ctype_receiverMessage c = (
    if c = \<C> ''DoNotUse_f10ac2_dr'' then range DoNotUse_f10ac2_ReceiverPair_E_Bool else
    if c = \<C> ''DoNotUse_f10ac2_ar'' then range DoNotUse_f10ac2_ReceiverBool else
    if c = \<C> ''DoNotUse_f10ac2_o'' then range DoNotUse_f10ac2_ReceiverE else
    undefined)"
  instance
    by(intro_classes)
end
...
"receiverDom = {\<C> ''DoNotUse_f10ac2_dr''}"

definition receiverRan :: "channel set" where
"receiverRan = {\<C> ''DoNotUse_f10ac2_ar'', \<C> ''DoNotUse_f10ac2_o''}"
...
"\<lambda>x. [\<C> ''DoNotUse_f10ac2_dr'' \<mapsto> Msg (DoNotUse_f10ac2_ReceiverPair_E_Bool x)]"
...
"\<lambda>x. [\<C> ''DoNotUse_f10ac2_ar'' \<mapsto> Msg (DoNotUse_f10ac2_ReceiverBool x)]"
  unfolding sbElemWell_def
  unfolding usclOkay_stream_def
  unfolding ctype_tsyn_def
  by simp
...
"\<lambda>x. [\<C> ''DoNotUse_f10ac2_o'' \<mapsto> Msg (DoNotUse_f10ac2_ReceiverE x)]"
  unfolding sbElemWell_def
  unfolding usclOkay_stream_def
  unfolding ctype_tsyn_def
  by simp
...
"receiverElem_dr null = sbeNull {\<C> ''DoNotUse_f10ac2_dr''}"
...
"receiverElem_ar null = sbeNull {\<C> ''DoNotUse_f10ac2_ar''}"
...
"receiverElem_o null = sbeNull {\<C> ''DoNotUse_f10ac2_o''}"
...
"receiver_list_dr []     = ubLeast {\<C> ''DoNotUse_f10ac2_dr''}"
...
"receiver_list_ar []     = ubLeast {\<C> ''DoNotUse_f10ac2_ar''}"
...
"receiver_list_o []     = ubLeast {\<C> ''DoNotUse_f10ac2_o''}"
...
lift_definition DoNotUse_f10ac2_receiver_stream_dr_h :: "('e\<times>bool) tsyn stream \<Rightarrow> ('e::countable) receiverMessage tsyn SB" is
"\<lambda> s. [(\<C> ''DoNotUse_f10ac2_dr'') \<mapsto> (tsynMap (DoNotUse_f10ac2_ReceiverPair_E_Bool)\<cdot>s)]"
...
"DoNotUse_f10ac2_receiver_stream_dr_h"
  apply(auto simp add: cfun_def DoNotUse_f10ac2_receiver_stream_dr_h_def map_fun_def comp_def)
  apply(rule cont_Abs_UB)
  apply(simp add: option_one_cont)
  by (metis DoNotUse_f10ac2_receiver_stream_dr_h.rep_eq ubrep_well)

lift_definition DoNotUse_f10ac2_receiver_stream_ar_h :: "bool tsyn stream \<Rightarrow> ('e::countable) receiverMessage tsyn SB" is
"\<lambda> s. [(\<C> ''DoNotUse_f10ac2_ar'') \<mapsto> (tsynMap (DoNotUse_f10ac2_ReceiverBool)\<cdot>s)]"
  unfolding ubWell_def usclOkay_stream_def ctype_tsyn_def
  by auto
...
"DoNotUse_f10ac2_receiver_stream_ar_h"
  apply(auto simp add: cfun_def DoNotUse_f10ac2_receiver_stream_ar_h_def map_fun_def comp_def)
  apply(rule cont_Abs_UB)
  apply(simp add: option_one_cont)
  by (metis DoNotUse_f10ac2_receiver_stream_ar_h.rep_eq ubrep_well)

lift_definition DoNotUse_f10ac2_receiver_stream_o_h :: "'e tsyn stream \<Rightarrow> ('e::countable) receiverMessage tsyn SB" is
"\<lambda> s. [(\<C> ''DoNotUse_f10ac2_o'') \<mapsto> (tsynMap (DoNotUse_f10ac2_ReceiverE)\<cdot>s)]"
  unfolding ubWell_def usclOkay_stream_def ctype_tsyn_def
  by auto

(* Do not use this, use receiverOut_stream_ar_o instead *)
lift_definition receiver_stream_o :: "('e) tsyn stream \<rightarrow> ('e::countable) receiverMessage tsyn SB" is
"DoNotUse_f10ac2_receiver_stream_o_h"
  apply(auto simp add: cfun_def DoNotUse_f10ac2_receiver_stream_o_h_def map_fun_def comp_def)
  apply(rule cont_Abs_UB)
  apply(simp add: option_one_cont)
  by (metis DoNotUse_f10ac2_receiver_stream_o_h.rep_eq ubrep_well)
...
"receiverElem_get_dr sbe = tsynApplyElem (inv DoNotUse_f10ac2_ReceiverPair_E_Bool) ((Rep_sbElem sbe) \<rightharpoonup> (\<C> ''DoNotUse_f10ac2_dr''))"

lift_definition receiver_get_stream_dr :: "('e::countable) receiverMessage tsyn SB \<rightarrow> ('e\<times>bool) tsyn stream" is
"\<lambda>sb. tsynMap (inv DoNotUse_f10ac2_ReceiverPair_E_Bool)\<cdot>(sb . (\<C> ''DoNotUse_f10ac2_dr''))"
  by(simp add: cfun_def)

definition receiverElem_get_ar :: "('e::countable) receiverMessage tsyn sbElem \<Rightarrow> (bool) tsyn" where
"receiverElem_get_ar sbe = tsynApplyElem (inv DoNotUse_f10ac2_ReceiverBool) ((Rep_sbElem sbe) \<rightharpoonup> (\<C> ''DoNotUse_f10ac2_ar''))"

lift_definition receiver_get_stream_ar :: "('e::countable) receiverMessage tsyn SB \<rightarrow> bool tsyn stream" is
"\<lambda>sb. tsynMap (inv DoNotUse_f10ac2_ReceiverBool)\<cdot>(sb . (\<C> ''DoNotUse_f10ac2_ar''))"
  by(simp add: cfun_def)

definition receiverElem_get_o :: "('e::countable) receiverMessage tsyn sbElem \<Rightarrow> ('e) tsyn" where
"receiverElem_get_o sbe = tsynApplyElem (inv DoNotUse_f10ac2_ReceiverE) ((Rep_sbElem sbe) \<rightharpoonup> (\<C> ''DoNotUse_f10ac2_o''))"

lift_definition receiver_get_stream_o :: "('e::countable) receiverMessage tsyn SB \<rightarrow> 'e tsyn stream" is
"\<lambda>sb. tsynMap (inv DoNotUse_f10ac2_ReceiverE)\<cdot>(sb . (\<C> ''DoNotUse_f10ac2_o''))"
  by(simp add: cfun_def)
...
lemma receiverelem_dr_dom[simp]: "sbeDom (receiverElem_dr x) = {\<C> ''DoNotUse_f10ac2_dr''}"
  apply(cases x)
  apply(simp add: receiverElem_dr.simps sbeDom_def receiverElem_raw_dr.rep_eq)
  by(simp add: receiverElem_dr.simps)

lemma receiverelem_ar_dom[simp]: "sbeDom (receiverElem_ar x) = {\<C> ''DoNotUse_f10ac2_ar''}"
  apply(cases x)
  apply(simp add: receiverElem_ar.simps sbeDom_def receiverElem_raw_ar.rep_eq)
  by(simp add: receiverElem_ar.simps)

lemma receiverelem_o_dom[simp]: "sbeDom (receiverElem_o x) = {\<C> ''DoNotUse_f10ac2_o''}"
  apply(cases x)
...
lemma receiver_stream_dr_dom[simp]: "ubDom\<cdot>(receiver_stream_dr\<cdot>x) = {\<C> ''DoNotUse_f10ac2_dr''}"
  by(simp add: receiver_stream_dr.rep_eq ubdom_insert DoNotUse_f10ac2_receiver_stream_dr_h.rep_eq)

lemma receiver_stream_ar_dom[simp]: "ubDom\<cdot>(receiver_stream_ar\<cdot>x) = {\<C> ''DoNotUse_f10ac2_ar''}"
  by(simp add: receiver_stream_ar.rep_eq ubdom_insert DoNotUse_f10ac2_receiver_stream_ar_h.rep_eq)

lemma receiver_stream_o_dom[simp]: "ubDom\<cdot>(receiver_stream_o\<cdot>x) = {\<C> ''DoNotUse_f10ac2_o''}"
  by(simp add: receiver_stream_o.rep_eq ubdom_insert DoNotUse_f10ac2_receiver_stream_o_h.rep_eq)
...
lemma receiver_stream_dr_id[simp]: "receiver_get_stream_dr\<cdot>(receiver_stream_dr\<cdot>x) = x"
  ...
  apply(simp add: ubGetCh_def DoNotUse_f10ac2_receiver_stream_dr_h.rep_eq)
  by (simp add: inj_def)
...
lemma receiver_stream_ar_id[simp]: "receiver_get_stream_ar\<cdot>(receiver_stream_ar\<cdot>x) = x"
  ...
  apply(simp add: ubGetCh_def DoNotUse_f10ac2_receiver_stream_ar_h.rep_eq)
  by (simp add: inj_def)
...
lemma receiver_stream_o_id[simp]: "receiver_get_stream_o\<cdot>(receiver_stream_o\<cdot>x) = x"
  ...
  apply(simp add: ubGetCh_def DoNotUse_f10ac2_receiver_stream_o_h.rep_eq)
  by (simp add: inj_def)
