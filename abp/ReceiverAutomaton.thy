...
datatype ('e::countable) receiverMessage = DoNotUse_70e88d_ReceiverPair_E_Bool "('e\<times>bool)" | DoNotUse_70e88d_ReceiverBool "bool" | DoNotUse_70e88d_ReceiverE "'e"
...
begin
  ...
  "ctype_receiverMessage c = (
    if c = \<C> ''DoNotUse_70e88d_dr'' then range DoNotUse_70e88d_ReceiverPair_E_Bool else
    if c = \<C> ''DoNotUse_70e88d_ar'' then range DoNotUse_70e88d_ReceiverBool else
    if c = \<C> ''DoNotUse_70e88d_o'' then range DoNotUse_70e88d_ReceiverE else
    undefined)"
  instance
    by(intro_classes)
end
...
"receiverDom = {\<C> ''DoNotUse_70e88d_dr''}"

definition receiverRan :: "channel set" where
"receiverRan = {\<C> ''DoNotUse_70e88d_ar'', \<C> ''DoNotUse_70e88d_o''}"
...
"\<lambda>x. [\<C> ''DoNotUse_70e88d_dr'' \<mapsto> Msg (DoNotUse_70e88d_ReceiverPair_E_Bool x)]"
...
"\<lambda>x. [\<C> ''DoNotUse_70e88d_ar'' \<mapsto> Msg (DoNotUse_70e88d_ReceiverBool x)]"
  unfolding sbElemWell_def usclOkay_stream_def ctype_tsyn_def
  by simp

(* Do not use this, use receiverElemOut_ar_o instead *)
lift_definition receiverElem_raw_o :: "'e \<Rightarrow> ('e::countable) receiverMessage tsyn sbElem" is
"\<lambda>x. [\<C> ''DoNotUse_70e88d_o'' \<mapsto> Msg (DoNotUse_70e88d_ReceiverE x)]"
  unfolding sbElemWell_def usclOkay_stream_def ctype_tsyn_def
  by simp
...
"receiverElem_dr null = sbeNull {\<C> ''DoNotUse_70e88d_dr''}"
...
"receiverElem_ar null = sbeNull {\<C> ''DoNotUse_70e88d_ar''}"
...
"receiverElem_o null = sbeNull {\<C> ''DoNotUse_70e88d_o''}"
...
"receiver_list_dr []     = ubLeast {\<C> ''DoNotUse_70e88d_dr''}"
...
"receiver_list_ar []     = ubLeast {\<C> ''DoNotUse_70e88d_ar''}"
...
"receiver_list_o []     = ubLeast {\<C> ''DoNotUse_70e88d_o''}"
...
lift_definition DoNotUse_70e88d_receiver_stream_dr_h :: "('e\<times>bool) tsyn stream \<Rightarrow> ('e::countable) receiverMessage tsyn SB" is
"\<lambda> s. [(\<C> ''DoNotUse_70e88d_dr'') \<mapsto> (tsynMap (DoNotUse_70e88d_ReceiverPair_E_Bool)\<cdot>s)]"
...
"DoNotUse_70e88d_receiver_stream_dr_h"
  apply(auto simp add: cfun_def DoNotUse_70e88d_receiver_stream_dr_h_def map_fun_def comp_def)
  apply(rule cont_Abs_UB)
  apply(simp add: option_one_cont)
  by (metis DoNotUse_70e88d_receiver_stream_dr_h.rep_eq ubrep_well)

lift_definition DoNotUse_70e88d_receiver_stream_ar_h :: "bool tsyn stream \<Rightarrow> ('e::countable) receiverMessage tsyn SB" is
"\<lambda> s. [(\<C> ''DoNotUse_70e88d_ar'') \<mapsto> (tsynMap (DoNotUse_70e88d_ReceiverBool)\<cdot>s)]"
  unfolding ubWell_def usclOkay_stream_def ctype_tsyn_def
  by auto
...
"DoNotUse_70e88d_receiver_stream_ar_h"
  apply(auto simp add: cfun_def DoNotUse_70e88d_receiver_stream_ar_h_def map_fun_def comp_def)
  apply(rule cont_Abs_UB)
  apply(simp add: option_one_cont)
  by (metis DoNotUse_70e88d_receiver_stream_ar_h.rep_eq ubrep_well)

lift_definition DoNotUse_70e88d_receiver_stream_o_h :: "'e tsyn stream \<Rightarrow> ('e::countable) receiverMessage tsyn SB" is
"\<lambda> s. [(\<C> ''DoNotUse_70e88d_o'') \<mapsto> (tsynMap (DoNotUse_70e88d_ReceiverE)\<cdot>s)]"
  unfolding ubWell_def usclOkay_stream_def ctype_tsyn_def
  by auto

(* Do not use this, use receiverOut_stream_ar_o instead *)
lift_definition receiver_stream_o :: "('e) tsyn stream \<rightarrow> ('e::countable) receiverMessage tsyn SB" is
"DoNotUse_70e88d_receiver_stream_o_h"
  apply(auto simp add: cfun_def DoNotUse_70e88d_receiver_stream_o_h_def map_fun_def comp_def)
  apply(rule cont_Abs_UB)
  apply(simp add: option_one_cont)
  by (metis DoNotUse_70e88d_receiver_stream_o_h.rep_eq ubrep_well)
...
"receiverElem_get_dr sbe = tsynApplyElem (inv DoNotUse_70e88d_ReceiverPair_E_Bool) ((Rep_sbElem sbe) \<rightharpoonup> (\<C> ''DoNotUse_70e88d_dr''))"

definition receiverElem_get_ar :: "('e::countable) receiverMessage tsyn sbElem \<Rightarrow> (bool) tsyn" where
"receiverElem_get_ar sbe = tsynApplyElem (inv DoNotUse_70e88d_ReceiverBool) ((Rep_sbElem sbe) \<rightharpoonup> (\<C> ''DoNotUse_70e88d_ar''))"

definition receiverElem_get_o :: "('e::countable) receiverMessage tsyn sbElem \<Rightarrow> ('e) tsyn" where
"receiverElem_get_o sbe = tsynApplyElem (inv DoNotUse_70e88d_ReceiverE) ((Rep_sbElem sbe) \<rightharpoonup> (\<C> ''DoNotUse_70e88d_o''))"
...
"\<lambda>sb. tsynMap (inv DoNotUse_70e88d_ReceiverPair_E_Bool)\<cdot>(sb . (\<C> ''DoNotUse_70e88d_dr''))"
  by(simp add: cfun_def)

lift_definition receiver_get_stream_ar :: "('e::countable) receiverMessage tsyn SB \<rightarrow> bool tsyn stream" is
"\<lambda>sb. tsynMap (inv DoNotUse_70e88d_ReceiverBool)\<cdot>(sb . (\<C> ''DoNotUse_70e88d_ar''))"
  by(simp add: cfun_def)

lift_definition receiver_get_stream_o :: "('e::countable) receiverMessage tsyn SB \<rightarrow> 'e tsyn stream" is
"\<lambda>sb. tsynMap (inv DoNotUse_70e88d_ReceiverE)\<cdot>(sb . (\<C> ''DoNotUse_70e88d_o''))"
  by(simp add: cfun_def)
...
lemma receiver_stream_dr_dom[simp]: "ubDom\<cdot>(receiver_stream_dr\<cdot>x) = {\<C> ''DoNotUse_70e88d_dr''}"
  by(simp add: receiver_stream_dr.rep_eq ubdom_insert DoNotUse_70e88d_receiver_stream_dr_h.rep_eq)
...
lemma receiver_stream_dr_len[simp]: "ubLen (receiver_stream_dr\<cdot>x) = #x"
  ...
  apply(simp add: ubGetCh_def DoNotUse_70e88d_receiver_stream_dr_h.rep_eq)
  by (simp add: tsynmap_slen usclLen_stream_def)

lemma receiver_stream_dr_id[simp]:
  assumes "ubDom\<cdot>ub = {\<C> ''DoNotUse_70e88d_dr''} "
  ...
  apply(simp add: DoNotUse_70e88d_receiver_stream_dr_h_def)
  apply(subst tsynmap_inv_id)
  using assms tsynbundle_ctype apply fastforce
  using assms ub_id_single by blast

lemma receiver_stream_ar_dom[simp]: "ubDom\<cdot>(receiver_stream_ar\<cdot>x) = {\<C> ''DoNotUse_70e88d_ar''}"
  by(simp add: receiver_stream_ar.rep_eq ubdom_insert DoNotUse_70e88d_receiver_stream_ar_h.rep_eq)

lemma receiver_stream_ar_len[simp]: "ubLen (receiver_stream_ar\<cdot>x) = #x"
  apply(subst uslen_ubLen_ch3)
  apply simp
  apply(simp add: receiver_stream_ar.rep_eq)
  apply(simp add: ubGetCh_def DoNotUse_70e88d_receiver_stream_ar_h.rep_eq)
  by (simp add: tsynmap_slen usclLen_stream_def)

lemma receiver_stream_ar_id[simp]:
  assumes "ubDom\<cdot>ub = {\<C> ''DoNotUse_70e88d_ar''} "
  ...
  apply(simp add: DoNotUse_70e88d_receiver_stream_ar_h_def)
  apply(subst tsynmap_inv_id)
  using assms tsynbundle_ctype apply fastforce
  using assms ub_id_single by blast

lemma receiver_stream_o_dom[simp]: "ubDom\<cdot>(receiver_stream_o\<cdot>x) = {\<C> ''DoNotUse_70e88d_o''}"
  by(simp add: receiver_stream_o.rep_eq ubdom_insert DoNotUse_70e88d_receiver_stream_o_h.rep_eq)

lemma receiver_stream_o_len[simp]: "ubLen (receiver_stream_o\<cdot>x) = #x"
  apply(subst uslen_ubLen_ch3)
  apply simp
  apply(simp add: receiver_stream_o.rep_eq)
  apply(simp add: ubGetCh_def DoNotUse_70e88d_receiver_stream_o_h.rep_eq)
  by (simp add: tsynmap_slen usclLen_stream_def)

lemma receiver_stream_o_id[simp]:
  assumes "ubDom\<cdot>ub = {\<C> ''DoNotUse_70e88d_o''} "
  ...
  apply(simp add: DoNotUse_70e88d_receiver_stream_o_h_def)
  apply(subst tsynmap_inv_id)
  using assms tsynbundle_ctype apply fastforce
  using assms ub_id_single by blast
...
lemma receiver_get_stream_dr_eq:
  assumes "ubDom\<cdot>ub1 = {\<C> ''DoNotUse_70e88d_dr''}"
      and "ubDom\<cdot>ub2 = {\<C> ''DoNotUse_70e88d_dr''}"
...
lemma receiver_get_stream_dr_conc[simp]:
  assumes "\<C> ''DoNotUse_70e88d_dr'' \<in> ubDom\<cdot>ub1"
      and "\<C> ''DoNotUse_70e88d_dr'' \<in> ubDom\<cdot>ub2"
...
lemma receiver_get_stream_ar_eq:
  assumes "ubDom\<cdot>ub1 = {\<C> ''DoNotUse_70e88d_ar''}"
      and "ubDom\<cdot>ub2 = {\<C> ''DoNotUse_70e88d_ar''}"
...
lemma receiver_get_stream_ar_conc[simp]:
  assumes "\<C> ''DoNotUse_70e88d_ar'' \<in> ubDom\<cdot>ub1"
      and "\<C> ''DoNotUse_70e88d_ar'' \<in> ubDom\<cdot>ub2"
...
lemma receiver_get_stream_o_eq:
  assumes "ubDom\<cdot>ub1 = {\<C> ''DoNotUse_70e88d_o''}"
      and "ubDom\<cdot>ub2 = {\<C> ''DoNotUse_70e88d_o''}"
...
lemma receiver_get_stream_o_conc[simp]:
  assumes "\<C> ''DoNotUse_70e88d_o'' \<in> ubDom\<cdot>ub1"
      and "\<C> ''DoNotUse_70e88d_o'' \<in> ubDom\<cdot>ub2"
