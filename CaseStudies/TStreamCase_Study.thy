...
(* Definition of tsSum6 and verification with tsum5 *)

(* Compute sum of previous inputs and emit it *)
definition tsSum6 :: "nat tstream \<rightarrow> nat tstream" where
"tsSum6 \<equiv> tsScanl plus 0"
...
(* Nth element of tsSum6 and tsum5 are equal *)
lemma tssum6_h2tsum5_h_snth:
...
(* tsSum6 equals tsum5 on event streams *)
lemma tssum6_h2tsum5_h: "tsScanl_h plus 0\<cdot>s = tsum5_h 0\<cdot>s"
  apply (rule snths_eq)
  apply (simp)
  by (simp add: tssum6_h2tsum5_h_snth)

(* tsSum6 equals tsum5 *)
lemma tssum62tsum5: "tsSum6=tsum5"
  by (simp add: tsScanl_def tsum5_def tsSum6_def tssum6_h2tsum5_h)
